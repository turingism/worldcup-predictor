<!-- 完整功能說明（繁體中文）。README 於 2026-07-26 精簡為產品主頁，此處保留每個 tab 的詳細走查、Kimi 報告對標與全部截圖。 -->
...
<p align="center">
  <img src="./screenshot-dashboard.png" alt="賽事看板：正在比賽 / 即將開賽 / 已結束" width="820">
...
<p align="center">
  <img src="./screenshot-dashboard.png" alt="Codex / Claude skill 開啟的世界盃比分預測器賽事看板" width="820">
...
- [Codex / Claude Skill 使用说明（简体）](./CODEX_SKILL.zh-CN.md)
...
<p align="center">
  <img src="./screenshot-mobile.png" alt="375px 手機端看板：LIVE 即時勝平負條、每場三段機率條、階段徽章與一鍵直達入口" width="300">
...
<p align="center">
  <img src="./screenshot-scoreboard.png" alt="正確比分機率盤：按玩法盤面逐檔給出模型機率，大比分自然浮現並突顯最可能比分" width="760">
...
<p align="center">
  <img src="./screenshot-narrative.png" alt="比賽解讀卡：把模型勝率翻成一句球迷語言，附動態讓球傾向與「非投注建議」聲明" width="760">
...
<p align="center">
  <img src="./screenshot-update.png" alt="右上角儲存庫更新偵測：落後遠端 main 的提交數 + 發現新版本提示彈窗" width="760">
...
<p align="center"><img src="./screenshot-manager.png" alt="對陣分析深度報告" width="760"></p>
...
<p align="center"><img src="./screenshot-lineup.png" alt="賽前(純模型) vs 首發確認 機率對比 + 逐人可用性" width="760"></p>
...
<p align="center"><img src="./screenshot-bracket.png" alt="2026 官方賽制括號投影" width="820"></p>
...
<p align="center"><img src="./screenshot-champ.png" alt="奪冠機率可信區間與貝氏實力榜" width="760"></p>
...
<p align="center">
  <img src="./screenshot-market.png" alt="市場對標 / CLV 誠實門檻逐條清單：樣本量 / 平均 CLV / t 值 / 跑贏閉盤比例 + 是否達標" width="760">
...
<p align="center"><img src="./screenshot-explainer.png" alt="機制解讀卡：Shin 去水水位結構、模型 vs 市場分歧（強制「市場對模型錯」先驗橫幅）、賽前線移動" width="760"></p>
...
<p align="center"><img src="./screenshot-jcreview.png" alt="競彩復盤 tab：輸入真實競彩讓球線與自己的判斷，模型預測即刻凍結，賽後填 90 分鐘比分做你/模型/市場三方對帳" width="760"></p>
...
<p align="center"><img src="./screenshot-xuanxue.png" alt="玄學占卜：七法 vs 誠實基線，涵蓋本屆與 4.9 萬場歷史回測" width="760"></p>
...
| **勝平負命中率** | **59.7%** | 三向 argmax 準確率——**全部國際賽混合口徑**（含大量預選賽/友誼賽）。僅世界盃正賽（as-of，2014/18/22/26 合併 n=295，`bt_wc.py`）：RPS 0.186 / 命中 61.0% CI[55.6, 66.8]——其中經典 64 隊時代各屆僅 53–59%（RPS≈0.20）；2026 同場閉盤賠率勝過模型（RPS 0.1462 vs 0.1514）。引用請用分層數字，勿用混合口徑 |
...
<p align="center">
  <img src="./screenshot-verify.png" alt="本屆實測驗證：36 場、賽果命中 55.6% 正趨近 ~59.5% 回測真值，含信賴度分桶與失手歸因" width="820">
...
> 📓 比賽日運行看一頁紙 **[比賽日運行手冊](./RUNBOOK.zh-CN.md)**。
