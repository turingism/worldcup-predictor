...
这是一个**免费开源**的个人项目。如果它帮你省了事、或让你看球多了点乐子，欢迎请作者喝杯咖啡——网页右上角点「**♥ 赞赏支持**」即可扫码（支付宝 / 微信）。

> **赞赏纯属自愿，不解锁任何功能、不构成购买任何预测服务**——所有功能对所有人永久免费。自部署时把你自己的收款码图片放到 `data/sponsor.png` 即生效（该文件默认在 `.gitignore` 中，不会被提交）。
