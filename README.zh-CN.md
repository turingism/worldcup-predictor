...
<p align="center">
  <img src="./docs/screenshot-mobile.png" alt="375px 手机端看板：LIVE 实时胜平负条、每场三段概率条、阶段徽章与一键直达入口" width="300">
...
<p align="center"><img src="./docs/screenshot-explainer.png" alt="机制解读卡：Shin 去水水位结构、模型 vs 市场分歧（强制「市场对模型错」先验横幅）、赛前线移动" width="760"></p>
...
<p align="center"><img src="./docs/screenshot-jcreview.png" alt="竞彩复盘 tab：录入真实竞彩让球线与自己的判断，模型预测即刻冻结，赛后填 90 分钟比分做你/模型/市场三方对账" width="760"></p>
